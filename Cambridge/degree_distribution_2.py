...
in_pfinal_1000 = in_fit[0]
in_covar_1000 = in_fit[1]
out_pfinal_1000 = out_fit[0]
out_covar_1000 = out_fit[1]

in_index_1000 = in_pfinal[1]
in_amp_1000 = 10.0**in_pfinal[0]
out_index_1000 = out_pfinal[1]
out_amp_1000 = 10.0**out_pfinal[0]
