...
print "Drawing Degree Distributions (log scale with both lines to fit)"
plt.figure()
plt.grid(True)
plt.loglog(in_values, in_hist, 'ro')
plt.loglog(in_values, powerlaw(in_values, in_amp, in_index),'r-')
plt.loglog(in_values, powerlaw(in_values, in_amp_1000, in_index_1000),'g-')
plt.legend(['In-Degree', 'Power-Law', 'Power-Law x<1000'])
plt.xlabel('In-Degree')
plt.ylabel('Number of Nodes (log10)')
plt.xlim([0, max_degree])
plt.savefig('results/figures/fit_both_log_in-degree_distribution.pdf')
plt.close()
...
plt.loglog(out_values, out_hist, 'bo')
plt.loglog(out_values, powerlaw(out_values, out_amp, out_index),'b-')
plt.loglog(out_values, powerlaw(out_values, out_amp_1000, out_index_1000),'g-')
plt.legend(['Out-Degree', 'Power-Law', 'Power-Law x<1000'])
plt.xlabel('Out-Degree')
plt.ylabel('Number of Nodes (log10)')
plt.xlim([0, max_degree])
plt.savefig('results/figures/fit_both_log_out-degree_distribution.pdf')
plt.close()
