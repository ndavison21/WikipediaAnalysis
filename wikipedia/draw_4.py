...
sys.stdout.flush()
g = nx.read_edgelist('data/wiki-Talk_4.txt', create_using=nx.DiGraph(), nodetype=int)
...
print "Saving Figure"
sys.stdout.flush()
plt.savefig('results/wiki_4_spring.pdf')
...
print "Saving Figure"
sys.stdout.flush()
plt.savefig('results/wiki_4_spectral.pdf')
plt.close()
