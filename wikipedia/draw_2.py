...
sys.stdout.flush()
g = nx.read_edgelist('data/wiki-Talk_2.txt', create_using=nx.DiGraph(), nodetype=int)
...
print "Saving Figure"
sys.stdout.flush()
plt.savefig('results/wiki_2_spring.pdf')
...
print "Saving Figure"
sys.stdout.flush()
plt.savefig('results/wiki_2_spectral.pdf')
plt.close()
